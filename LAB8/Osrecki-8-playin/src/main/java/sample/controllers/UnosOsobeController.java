...
public class UnosOsobeController implements Initializable {
    ...
    public void dodaj() {
        ...
        if (ime.isBlank() || prezime.isBlank() || starost == 0 || zupanija == null || bolest == null || kontakti.isEmpty()) {
            ...
            if (ime.isBlank()) Main.prikaziErrorIndicator(imeOsobe);
            if (prezime.isBlank()) Main.prikaziErrorIndicator(prezimeOsobe);
            if (zupanija == null) Main.prikaziErrorIndicator(zupanijaOsobe);
            if (bolest == null) Main.prikaziErrorIndicator(bolestOsobe);
            if (kontakti.isEmpty()) Main.prikaziErrorIndicator(kontaktiOsobeMenuBtn);
