...
//        ispisPretrazenihOsoba(osobe, pretraga);
        ...
        Path zupanijeOutput = Path.of("./dat", "zupanije_output.txt");
        try {
            Files.writeString(zupanijeOutput, "");
            for (Zupanija zupanija : zupanije) {
                Files.writeString(zupanijeOutput, "ID: " + zupanija.getId() + "\n", StandardOpenOption.APPEND);
                Files.writeString(zupanijeOutput, "Naziv: " + zupanija.getNaziv() + "\n", StandardOpenOption.APPEND);
                Files.writeString(zupanijeOutput, "Broj stanovnika: " + zupanija.getBrojStanovnika() + "\n", StandardOpenOption.APPEND);
                Files.writeString(zupanijeOutput, "Broj zaraženih: " + zupanija.getBrojZarazenih() + "\n", StandardOpenOption.APPEND);
                Files.writeString(zupanijeOutput, "Postotak zaraženih: " + zupanija.getPostotakZarazenih() + "\n", StandardOpenOption.APPEND);
            }
        } catch (IOException e) {
            e.printStackTrace();
        }

        File zupanijeOutput2 = new File("./dat", "zupanije_output2.txt");
        try (PrintStream ps = new PrintStream(zupanijeOutput2)) {
            for (Zupanija zupanija : zupanije) {
                ps.println("ID: " + zupanija.getId());
                ps.println("Naziv: " + zupanija.getNaziv());
                ps.println("Broj stanovnika: " + zupanija.getBrojStanovnika());
                ps.println("Broj zaraženih: " + zupanija.getBrojZarazenih());
                ps.println("Postotak zaraženih: " + zupanija.getPostotakZarazenih());
            }
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }

        File zupanijeOutput3 = new File("./dat", "zupanije_output3.txt");
        try (PrintWriter pw = new PrintWriter(new FileWriter(zupanijeOutput3))) {
            for (Zupanija zupanija : zupanije) {
                pw.println("ID: " + zupanija.getId());
                pw.println("Naziv: " + zupanija.getNaziv());
                pw.println("Broj stanovnika: " + zupanija.getBrojStanovnika());
                pw.println("Broj zaraženih: " + zupanija.getBrojZarazenih());
                pw.println("Postotak zaraženih: " + zupanija.getPostotakZarazenih());
            }
        } catch (IOException e) {
            e.printStackTrace();
        }

        String FILENAME4 = "./dat/zupanije_output4.txt";
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(FILENAME4))) {
            for (Zupanija zupanija : zupanije) {
                bw.write("ID: " + zupanija.getId() + "\n");
                bw.write("Naziv: " + zupanija.getNaziv() + "\n");
                bw.write("Broj stanovnika: " + zupanija.getBrojStanovnika() + "\n");
                bw.write("Broj zaraženih: " + zupanija.getBrojZarazenih() + "\n");
                bw.write("Postotak zaraženih: " + zupanija.getPostotakZarazenih() + "\n");
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
